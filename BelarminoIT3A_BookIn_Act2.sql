...
INSERT INTO `order` VALUES (1,1,'2023-01-01',1),(2,2,'2023-01-02',1),(3,3,'2023-01-03',1),(4,4,'2023-01-06',1),(5,5,'2023-01-06',1),(6,6,'2023-01-08',1),(7,7,'2023-01-12',1),(8,8,'2023-01-18',1),(9,9,'2023-01-25',1),(10,10,'2023-02-02',1),(11,1,'2023-02-06',1),(12,2,'2023-02-14',0),(13,3,'2023-02-16',0);
...
CREATE TABLE `order_line` (
  ...
  CONSTRAINT `order_line_ibfk_2` FOREIGN KEY (`ORDER_ID`) REFERENCES `order` (`ORDER_ID`)
...
INSERT INTO `order_line` VALUES (1,1234567890,1,100,100,1),(2,1234567891,1,200,400,2),(3,1234567892,2,300,900,3),(4,1234567893,3,400,400,1),(5,1234567894,4,400,800,2),(6,1234567895,5,210,630,3),(7,1234567896,6,500,2000,4),(8,1234567897,7,255,255,1),(9,1234567898,7,560,1120,2),(10,1234567899,8,600,1800,3),(11,1234567880,8,525,2100,4),(12,1234567890,9,100,100,1),(13,1234567891,10,100,100,1),(14,1234567896,11,500,500,1),(15,1234567896,12,500,1000,2),(16,1234567897,13,255,510,2);
...
BEGIN
		...
		REPEAT
			...
			SET TOTAL_SPENT = (SELECT SUM(COST_LINE) FROM ORDER_LINE, `ORDER`
								WHERE ORDER_LINE.ORDER_ID = `ORDER`.ORDER_ID  AND `ORDER`.CUSTOMER_ID = CURRENT_CUST_ID)
...
-- Dump completed on 2023-02-17 15:09:12
